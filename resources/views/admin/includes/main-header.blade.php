...
<nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    ...
    <ul class="nav navbar-nav ml-auto">
        ...
        {{--                <a class="top-nav" data-toggle="dropdown" href="#" role="button" aria-haspopup="true"--}}
        {{--                   aria-expanded="false">--}}
        {{--                    Language--}}
        {{--                </a>--}}
        {{--            <div class="dropdown-menu">--}}
        ...
        {{--                @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)--}}
        {{--                        <a  class="dropdown-item align-content-center" rel="alternate" hreflang="{{ $localeCode }}" href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}">--}}
        {{--                            {{ $properties['native'] }}--}}
        {{--                        </a>--}}
        {{--                @endforeach--}}
        {{--            </div>--}}
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">{{trans('auth.logout')}}</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                {{trans('auth.Are You Sure For Logout?')}}
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">{{trans('auth.close')}}</button>
                <a class="btn btn-primary" href="{{route('admin.logout')}}">{{trans('auth.logout')}}</a>
            </div>
        </div>
    </div>
</div>
